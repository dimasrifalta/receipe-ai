...
export default function Home() {
  ...
  const faqs = [
    {
      ...
      answer: 'Our AI system analyzes your dietary preferences, health goals, and cooking style to create recipes that are unique to you. It continuously learns from your feedback and choices to improve its suggestions over time.'
    },
    {
    ...
    },
    {
      ...
      answer: 'You can specify allergies and sensitivities in your profile. Our system will ensure these ingredients are excluded from all your recipe recommendations.'
    },
    {
      question: "Can I adjust my meal plans after they've been created?",
      answer: 'Yes, you can easily modify any recipe or swap out ingredients to suit your preferences or what you have on hand.'
    },
    {
      question: 'What makes your AI-driven meal planning different from other meal planning services?',
      answer: 'Our AI learns from your interactions and continuously improves its recommendations, creating a truly personalized experience that adapts to your changing preferences and needs.'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <div className="flex items-center">
              ...
              <span className="text-green-800 dark:text-green-400 text-xl font-medium">Recipe AI</span>
            </div>
          </div>
          <div className="flex items-center space-x-6">
           
            <button onClick={() => scrollToSection('benefits-section')} className="text-sm text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors">
              Benefit
            </button>
            <button onClick={() => scrollToSection('support-section')} className="text-sm text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors">
              Support
            </button>
            {isLoading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7">
              <h1 className="text-4xl md:text-5xl font-light mb-6 text-gray-800 dark:text-gray-100 leading-tight">
                ...
                <span className="font-medium text-green-600 dark:text-green-400">AI-Powered Personalization</span>
              </h1>
              ...
              <div className="flex items-center gap-6 flex-wrap">
                <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm">
                  <div className="text-4xl font-bold mb-1 text-green-600">95%</div>
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm">
                  <div className="text-4xl font-bold mb-1 text-green-600">25%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700">
              <div className="p-6 flex flex-col justify-between h-full">
                <div>
                  <h3 className="text-xl font-medium mb-2">Savory Quinoa and Roasted Vegetable Bowl</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-2">
                    A nutritious and filling bowl featuring fluffy quinoa, perfectly roasted seasonal vegetables, and a zesty herb dressing.
                  </p>
                </div>
                <Link 
                  href="/recipe/1" 
            ...
            <div className="bg-green-100 dark:bg-green-900/30 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-green-200 dark:border-green-800/50">
              <div className="p-6 flex flex-col justify-between h-full">
                <div>
                  <h3 className="text-xl font-medium mb-2">Herb-Infused Grilled Chicken with Seasonal Greens</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm mb-4 line-clamp-2">
                    Tender chicken marinated with fresh herbs, grilled to perfection and served with a vibrant seasonal greens salad.
                  </p>
                </div>
                <Link 
                  href="/recipe/2" 
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
              <div className="p-6 flex flex-col justify-between h-full">
                <div>
                  <h3 className="text-xl font-medium mb-2">Mediterranean Lentil and Kale Salad</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-2">
                    A protein-rich salad with hearty lentils, fresh kale, Mediterranean herbs, and a tangy lemon dressing.
                  </p>
                </div>
                <Link 
                  href="/recipe/3" 
      ...
      {/* Benefits Section */}
      <section id="benefits-section" className="py-16 px-4 md:px-0 bg-white dark:bg-gray-900">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-10">
            <h2 className="text-3xl font-light text-gray-800 dark:text-gray-100">
              Benefits
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Get meal plans tailored to your unique dietary needs, preferences, and goals,
              ensuring a balanced and enjoyable diet.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-green-100 dark:bg-green-900/30 rounded-3xl p-8 h-80 flex flex-col justify-center items-center text-center">
              <h3 className="text-xl font-medium mb-4 text-green-800 dark:text-green-300">Personalized Nutrition</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-80 flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-4 text-gray-800 dark:text-gray-200">Time-Saving Convenience</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Benefit 3 */}
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-80 flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-4 text-gray-800 dark:text-gray-200">Healthier Eating Habits</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Benefit 4 */}
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-80 flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-4 text-gray-800 dark:text-gray-200">Cost-Effective Shopping</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Benefit 5 */}
            <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-80 flex flex-col justify-center">
              <h3 className="text-xl font-medium mb-4 text-gray-800 dark:text-gray-200">Seamless Grocery Delivery</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-3xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <div className="text-green-600 dark:text-green-400 font-medium mb-2">01</div>
                <h3 className="text-2xl font-medium mb-4">Personalize Your Profile</h3>
                ...
                <div className="mt-8 text-green-800 dark:text-green-400">01/03</div>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 md:p-12">
                <h3 className="text-2xl font-medium mb-4">Have questions or need help with Recipe AI?</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Our dedicated support team is ready to assist you. Get the answers and assistance you need to make the most of your meal planning experience.
                </p>
      ...
      <footer className="bg-green-900 text-white py-12 px-4 md:px-0">
        <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-green-200">
                  ...
                  <li><Link href="#" className="hover:text-white transition-colors">Seasonal</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-green-200">
                  <li><Link href="#" className="hover:text-white transition-colors">Nutrition Tips</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">Cooking Guides</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">Healthy Living</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-green-200">
                  <li><Link href="#" className="hover:text-white transition-colors">Account Settings</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">My Recipes</Link></li>
          ...
          <div className="pt-8 border-t border-green-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-green-200 mb-4 md:mb-0">© 2025 Recipe AI. All rights reserved.</p>
